"""
URL configuration for myntrastore project.
...
urlpatterns = [
    ...
    path("api/v1/products/<int:pk>/",views.ProductDetilView.as_view()),
    path("api/v1/products/<int:pk>/addtocart/",views.AddToCartView.as_view()),
    path('api/v1/order/',views.Checkout.as_view()),
    path('api/v1/order/summary/',views.OrderSummaryView.as_view()),
    path('api/v1/payment/verification/',views.PyamentVerification.as_view()),
]
